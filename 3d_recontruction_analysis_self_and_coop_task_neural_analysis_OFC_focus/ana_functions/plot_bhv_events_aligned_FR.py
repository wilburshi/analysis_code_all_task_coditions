    ...
    for ianatype in np.arange(0,nanatypes,1):
        ...
        for icell in np.arange(0,ncells,1):
            ...
            try:
                ...
                try:
                    spike_channel = list(clusters_info_data[clusters_info_data['cluster_id']==clusterID]['ch'])[0]
                except:
                    spike_channel = list(clusters_info_data[clusters_info_data['id']==clusterID]['ch'])[0]
