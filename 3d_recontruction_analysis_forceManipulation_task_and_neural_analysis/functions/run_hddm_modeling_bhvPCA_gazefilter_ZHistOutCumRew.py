...
def run_hddm_modeling_bhvPCA_gazefilter_ZHistOutCumRew(df_animal_data, animal_id, samples, burn, thin, doNogazeOnly): # Modified signature
    """
    ...
    if not doNogazeOnly:
        model = hddm.HDDMRegressor(
                                    ...
                                    [
                                        ...
                                        # 'v ~ self_mean_speed + partner_speed_std + self_speed_std',
                                        # 'v ~ self_gaze_auc + partner_mean_speed + partner_speed_std + self_mean_speed',
                                        # 'v ~ self_gaze_auc + partner_speed_std + self_speed_std',
                                        # 'v ~ self_gaze_auc + partner_speed_std',
                                        # 'a ~ failed_pulls_before_reward + time_since_last_reward'
                                        # 'a ~ time_since_last_reward + self_mean_speed + C(condition)'
                                        # 'a ~ time_since_last_reward'
                                        # 'a ~ failed_pulls_before_reward'
                                        'z ~ prev_trial_outcome + cumulative_reward' 
                                    ],
                                    include=['v', 'a', 'z', 't'],
