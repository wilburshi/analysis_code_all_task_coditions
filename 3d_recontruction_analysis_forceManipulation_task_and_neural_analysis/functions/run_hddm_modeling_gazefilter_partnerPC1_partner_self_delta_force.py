...
def run_hddm_modeling_gazefilter_partnerPC1_partner_self_delta_force(df_animal_data, animal_id, samples, burn, thin): # Modified signature
    """
    ...
    model_nogaze = hddm.HDDMRegressor(
                                        ...
                                        [
                                            ...
                                            'v ~ self_LS_mean + self_LS_std + partner_PC1_mean + partner_PC1_std + delta_self_force_prev + delta_partner_force_withself',
