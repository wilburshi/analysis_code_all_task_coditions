...
def run_hddm_modeling_bhvPCA_gazeInteract(df_animal_data, animal_id, samples, burn, thin, doNogazeOnly): # Modified signature
    """
    ...
    model_nogaze = hddm.HDDMRegressor(
                                        ...
                                        [
                                            ...
                                            'v ~ self_gaze_auc * partner_mean_speed + self_gaze_auc * partner_speed_std + self_mean_speed',
